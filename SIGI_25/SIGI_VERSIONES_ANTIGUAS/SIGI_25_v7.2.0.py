...
=============================================================================
 ...
 VERSIÓN:  v7.2.0 (Dynamic Column Mapping & F2 Fix)
 FECHA:    Febrero 2026
 
 NOVEDADES:
 - Ajuste de Fase 2 (Variables) según requerimientos específicos de columnas.
 - Detección dinámica de columnas UNIDAD y MEDIOS DE VERIFICACIÓN en origen.
 - Soporte para archivos que tienen o no tienen columna de Unidad.
 - Se mantiene la lógica "Francotirador" (+3, +5 filas).
=============================================================================
"""
...
def procesar_archivo(ruta_archivo):
    ...
    try:
        ...
        for nombre_hoja in hojas:
            ...
            # Indices Base (Búsqueda por nombre de columna)
    ...
    for archivo in archivos:
        ...
        for _, r in subset.iterrows():
            ...
            rows.append({
                ...
                "texto_ayuda": None, "unidad": unidad, "valor_obligatorio": 1,
                "permite_medio_escrito": 1, "usa_ultimo_valor_ano": 1
            })
            rows.append({
                ...
                "APLICA_SIN_INFORMACION": 1, "APLICA_VAL_PERS_JUR": None, "requiere_medio": None,
                "texto_ayuda": None, "unidad": unidad, "valor_obligatorio": 1,
                "permite_medio_escrito": 0, "usa_ultimo_valor_ano": 1
            })
...
def ejecutar_masivo():
    ...
    print(f"\n[SIGI 25 v7.2.0] PROCESO MASIVO CON FASE 2 CORREGIDA ({len(archivos)} archivos)")
