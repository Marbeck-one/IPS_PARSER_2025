...
# =============================================================================
# IPS_PARSER_v3.7.2 - HERENCIA AUTOMÁTICA + FILTRO DE FALSOS POSITIVOS
# =============================================================================

class IPSParserV372:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.output_file = os.path.join(folder_path, "IPS_CONSOLIDADO_V3.7.2.xlsx")
        self.data_tree = {} 
        self.flat_data = [] 
        self.variable_data = [] 
    ...
    def configure(self):
        print("\n" + "="*60)
        print("   CONFIGURACIÓN MAESTRA v3.7.2")
        print("="*60)
    ...
    def find_center_responsibility(self, df):
        ...
        for r in range(limit_row):
            for c in range(limit_col):
                ...
                # --- CORRECCIÓN CRÍTICA v3.7.2 ---
                # Si la celda empieza con "RESPONSABLE", es un encabezado de columna. IGNORAR.
                ...
                if "CENTRO DE RESPONSABILIDAD" in val_upper:
                    ...
                    # Si la celda actual es solo el título, buscar en la celda de la derecha
        ...
        for idx_file, file_path in enumerate(files):
            ...
            for sheet in sheet_names:
                ...
                if center_resp_name:
                    ...
                    if is_data_sheet:
                        if last_found_center:
                            centro_uso = last_found_center # Herencia
                            print(f"    [HERENCIA] Hoja '{sheet}' usa equipo: '{centro_uso}'")
                        else:
                            centro_uso = "No aplica" # Fallback
                            print(f"    [AVISO] Equipo no encontrado en '{sheet}'. Asignando 'No aplica'.")
                ...
                for i in range(h_idx + 1, len(df)):
                    ...
                    # 1. CARGA BRUTA (Con columna EQUIPO inyectada)
                    row_data = {
                        "ARCHIVO": file_name, 
                        "HOJA": sheet, 
                        "EQUIPO": centro_uso, # Inyección Automática
                        "NÚMERO": final_code,
                    ...
                    for mes_num, mes_key in meses_vars:
                        ...
                        var_a = {
                            ...
                            "CENTRO_RESP_COD": centro_uso, # Inyección Automática
                            "COD_REGION": 0,
    ...
    def export_excel(self):
        ...
        for fname, sheets in self.data_tree.items():
            ...
            for sname, rows in sheets.items():
                ...
                # Headers: EQUIPO aparecerá automáticamente al inicio porque se insertó así en el dict row_data
