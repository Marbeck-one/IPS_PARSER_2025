...
# =============================================================================
# IPS_PARSER_v3.7.3 - ALERTA OBLIGATORIA (HUMAN IN THE LOOP)
# =============================================================================

class IPSParserV373:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.output_file = os.path.join(folder_path, "IPS_CONSOLIDADO_V3.7.3.xlsx")
        self.data_tree = {} 
        self.flat_data = [] 
        self.variable_data = [] 
    ...
    def configure(self):
        print("\n" + "="*60)
        print("   CONFIGURACIÓN MAESTRA v3.7.3")
        print("="*60)
    ...
    def ask_center_resp_manual(self, sheet_name, file_name, last_found):
        ...
        print("  Opciones:")
        print("   [n] Asignar 'No aplica' (Recomendado si no tiene info).")
        
        if last_found:
            print(f"   [h] Heredar de hoja anterior: '{last_found}'")
        else:
            print("   [h] (Heredar no disponible - Es el primero o no hubo anterior)")
        ...
        while True:
            ...
            if choice == 'h':
                ...
                else: print("     [ERROR] No hay nada que heredar. Elija otra opción.")
    ...
    def find_center_responsibility(self, df):
        ...
        for r in range(limit_row):
            for c in range(limit_col):
                ...
                # IGNORAR COLUMNA DE TABLA QUE EMPIEZA CON RESPONSABLE
                ...
                if "CENTRO DE RESPONSABILIDAD" in val_upper:
                    ...
                    # Buscar en la celda siguiente si no hay ':'
        ...
        for idx_file, file_path in enumerate(files):
            ...
            for sheet in sheet_names:
                ...
                if center_resp_name:
                    ...
                    # VERIFICAR SI LA HOJA TIENE DATOS (Para no alertar en hojas vacías)
                    is_data_sheet = False
                    ...
                    if is_data_sheet:
                        # ALERTA OBLIGATORIA: El usuario decide qué hacer
                        centro_uso = self.ask_center_resp_manual(sheet, file_name, last_found_center)
                        
                        if centro_uso is None: 
                            print("     -> Saltando hoja por decisión del usuario.")
                            continue # Saltar hoja
                        
                        # Actualizar memoria solo si se seleccionó un nombre válido
                ...
                for i in range(h_idx + 1, len(df)):
                    ...
                    row_data = {
                        "ARCHIVO": file_name, 
                        "HOJA": sheet, 
                        "EQUIPO": centro_uso, # DATO CONFIRMADO POR USUARIO
                        "NÚMERO": final_code,
                    ...
                    for mes_num, mes_key in meses_vars:
                        ...
                        var_a = {
                            ...
                            "CENTRO_RESP_COD": centro_uso, # DATO CONFIRMADO POR USUARIO
                            "COD_REGION": 0,
