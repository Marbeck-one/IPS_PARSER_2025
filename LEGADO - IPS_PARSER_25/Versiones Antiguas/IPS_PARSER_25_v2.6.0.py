...
# =============================================================================
# IPS_PARSER_v2.7.0 - MEMORIA INTELIGENTE (SKIP ALL / GENERATE ALL)
# =============================================================================

class IPSParserV270:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.output_file = os.path.join(folder_path, "IPS_CONSOLIDADO_V2.7.xlsx")
        self.data_tree = {} 
        self.flat_data = [] 
        ...
        self.memory_skip = set()      # Textos que siempre se saltan (ej: "Mujeres")
        self.memory_generate = False  # Si True, siempre genera código para "NUEVO"
        self.memory_skip_empty = False # Si True, salta siempre los vacíos

    def configure(self):
        print("\n" + "="*50)
        print("   CONFIGURACIÓN v2.7 (MEMORIA INTELIGENTE)")
        print("="*50)
        ...
        print("NOTA: Durante el proceso podrás elegir 'Saltar Siempre' para textos repetitivos.")
        print("-" * 50)
    ...
    def ask_header_action(self, msg):
        print(f"\n[ERROR ESTRUCTURA] {msg}")
        print("   [s] Saltar esta hoja.")
        print("   [d] Detener proceso.")
        while True:
    ...
    def ask_weird_row_action(self, row_idx, content, is_new_indicator=False):
        # 1. Chequeo de Memoria: ¿Ya decidimos sobre esto?
        ...
        # 2. Si no, preguntar
        print(f"\n[FILA EXTRAÑA #{row_idx}] Columna NÚMERO dice: '{content}'")
        
        if is_new_indicator:
            print("   [g]  Generar Código (Solo esta vez).")
            print("   [ga] Generar SIEMPRE códigos automáticos (No volver a preguntar).")
        else:
            print("   [g]  Generar Código (Tratar como indicador válido).")
        
        print("   [s]  Saltar (Solo esta vez).")
        print(f"   [x]  Saltar SIEMPRE filas que digan '{content}' (Recomendado para títulos/basura).")
        print("   [d]  Detener proceso.")
        ...
        while True:
            ...
            if choice == 'ga' and is_new_indicator:
                ...
                print("     -> [MEMORIA] Se generarán códigos automáticamente de ahora en adelante.")
                return 'auto'
            ...
            if choice == 'x':
                if content == "[VACÍO]":
                    self.memory_skip_empty = True
                else:
                    self.memory_skip.add(clean_content)
                print(f"     -> [MEMORIA] Se ignorarán todas las filas '{content}'.")
                return 'skip'
    ...
    def process_folder(self):
        ...
        for file_path in files:
            ...
            for sheet in sheet_names:
                ...
                if h_idx is None:
                    print(f"  [OMITIDO] Hoja '{sheet}' sin tabla de datos.")
                    continue
                ...
                for i in range(h_idx + 1, len(df)):
                    ...
                    if is_empty or is_new:
                        ...
                        # Si tiene texto en indicador es candidato a ser nuevo
                        if ind_val and str(ind_val).strip() not in ["", "0", "No aplica"]:
                            ...
                            # Solo avisar si no está en modo automático masivo
                        ...
                        # Caso texto raro (Mujeres, Hombres, NÚMERO repetido)
    ...
    def export_excel(self):
        ...
        row_idx = 1
        FULL_WIDTH = 64 # Hasta columna BL
