...
# =============================================================================
# IPS_HYBRID_v1.0.4 - SKIP OPTION ADDED
# =============================================================================

class IPSParserHybridV104:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.output_file = os.path.join(folder_path, "IPS_CONSOLIDADO_v1.0.4.xlsx")
        self.data_tree = {} 
        self.flat_data = [] 
        self.variable_data = [] 
    ...
    def configure(self):
        print("\n" + "="*60)
        print("   CONFIGURACIÓN MAESTRA v1.0.4")
        print("="*60)
    ...
    def ask_id_extraction(self, extracted_id, row_idx):
        ...
        print("   [a]  Usar SIEMPRE códigos encontrados en el texto.")
        print("   [n]  No usar.")
        while True:
    ...
    def ask_missing_id_strategy(self, row_idx, prev_id):
        ...
        print(f"   [s]  Saltar esta fila (No es un indicador válido).") # <--- NUEVA OPCIÓN
        print(f"   [p]  Usar el ID del registro anterior: '{prev_id}'.")
        print(f"   [n]  Generar código NUEVO único (GEN_X).")
        print(f"   [na] Generar SIEMPRE código nuevo.")

        while True:
            choice = input("   >> Elija: ").lower().strip()
            if choice == 's': return 'skip' # <--- RETORNO SKIP
            ...
            for sheet in xls.sheet_names:
                ...
                for loop_idx, h_idx in enumerate(header_indices):
                    ...
                    for i in range(h_idx + 1, end_idx):
                        ...
                        if not raw_num or raw_num.lower() == "nan":
                            ...
                            if not raw_num or raw_num.lower() == "nan":
                                ...
                                if is_valid_row:
                                    ...
                                    if strat == 'skip': continue # <--- NUEVA LOGICA: SALTAR
                        ...
                        off1, off2 = self.find_operand_offsets(df, i, set())
...
if __name__ == "__main__":
    ...
    IPSParserHybridV104(path).process_folder()