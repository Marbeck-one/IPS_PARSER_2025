...
# =============================================================================
# IPS_HYBRID_v1.1.0 - FIX OPERAND DESCRIPTIONS (ROW MAPPING)
# =============================================================================

class IPSParserHybridV110:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.output_file = os.path.join(folder_path, "IPS_CONSOLIDADO_v1.1.0_OCT-NOV-DIC_2025.xlsx")
        self.data_tree = {} 
        self.flat_data = [] 
        self.variable_data = [] 
    ...
    def configure(self):
        print("\n" + "="*60)
        print("   CONFIGURACIÓN MAESTRA v1.1.0")
        print("="*60)
                ...
                for loop_idx, h_idx in enumerate(header_indices):
                    ...
                    for i in range(h_idx + 1, end_idx):
                        ...
                        row_data = {
                            ...
                            "Descripción Operando 1": gd(i, c_map["op_desc"]),       # <-- CORREGIDO: Fila Madre
                            "Descripción Operando 2": gd(idx_op1, c_map["op_desc"]), # <-- CORREGIDO: Fila Op 1
...
if __name__ == "__main__":
    ...
    IPSParserHybridV110(path).process_folder()