...
# =============================================================================
# IPS_PARSER_v2.2.0 - ORDEN DE COLUMNAS CORREGIDO
# =============================================================================

class IPSParserV220:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.output_file = os.path.join(folder_path, "IPS_CONSOLIDADO_V2.2.xlsx")
        self.data_tree = {} 
        self.flat_data = [] 
        ...
        for file_path in files:
            ...
            for sheet in sheet_names:
                ...
                for i in range(h_idx + 1, len(df)):
                    ...
                    # ---------------------------------------------------------
                    # CONSTRUCCIÓN ORDENADA DE COLUMNAS (ORDEN SOLICITADO)
                    # ---------------------------------------------------------
                    row_data = {
                        "ARCHIVO": file_name, 
                        "HOJA": sheet, 
                    ...
                    # Meses (Insertados AQUÍ para cumplir el orden)
    ...
    def export_excel(self):
        ...
        for fname, sheets in self.data_tree.items():
            ...
            for sname, rows in sheets.items():
                ...
                # Ocultar ARCHIVO y HOJA de las columnas visuales
