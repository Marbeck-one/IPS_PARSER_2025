...
# =============================================================================
# IPS_PARSER_v3.1.0 - CONTEXTO TOTAL Y PROTECCIÓN DE GUARDADO
# =============================================================================

class IPSParserV310:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.output_file = os.path.join(folder_path, "IPS_CONSOLIDADO_V3.1.xlsx")
        self.data_tree = {} 
        self.flat_data = [] 
    ...
    def configure(self):
        print("\n" + "="*60)
        print("   CONFIGURACIÓN MAESTRA v3.1")
        print("="*60)
    ...
    def ask_weird_row_action(self, row_idx, content, file_name, sheet_name):
        ...
        # AQUI ESTÁ EL CAMBIO DE CONTEXTO SOLICITADO
                ...
                for i in range(h_idx + 1, len(df)):
                    ...
                    if is_empty or is_new:
                        ...
                        if ind_val and str(ind_val).strip() not in ["", "0", "No aplica"]:
                            # Pasamos file_name y sheet al prompt
