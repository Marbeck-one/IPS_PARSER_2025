...
# =============================================================================
# IPS_ADP_PARSER_v1.1.0 - SEPARACIÓN DE 5 HOJAS (PROYEC vs SIG)
# =============================================================================

class IPS_ADP_Parser:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.output_file = os.path.join(folder_path, "ADP_CONSOLIDADO_v20260223.xlsx")
        
        # Memorias separadas para Proyecciones y SIG
        self.tree_proy = {} 
        self.tree_sig = {} 
    ...
    def configure(self):
        print("\n" + "="*60)
        print("   CONFIGURACIÓN MAESTRA ADP v1.1.0 (Split 5 Hojas)")
        print("="*60)
    ...
    def process_folder(self):
        ...
        for idx_file, file_path in enumerate(files):
            ...
            # Inicializar los diccionarios para este archivo
            ...
            for sheet in sheet_names:
                ...
                # Identificar si es Proyección o SIG
                    ...
                    if str_num != "" and str_num.upper() not in ["NAN", "NONE"]:
                        ...
                        for mes in self.meses_fijos:
                            if mes in month_cols:
                                ...
                                # **LOGICA EXCLUSIVA PARA SIG: DATOS_VARIABLES**
                                if is_sig:
                                    if str(val_op1).strip() != "":
                                        self.variable_data_sig.append({"PERIODO (Mes)": mes, "VARIABLE_COD": f"{str_num}_A", "VALOR_TOTAL": val_op1, "ARCHIVO": file_name_correct, "HOJA": sheet})
                                    if str(val_op2).strip() != "":
                                        self.variable_data_sig.append({"PERIODO (Mes)": mes, "VARIABLE_COD": f"{str_num}_B", "VALOR_TOTAL": val_op2, "ARCHIVO": file_name_correct, "HOJA": sheet})
                            else:
                                val_op1, val_op2 = "", ""
                        ...
                        # Almacenar en la lista correspondiente
                        if is_proy:
    ...
    def _render_estilizada(self, ws, tree_data):
        """Función auxiliar para renderizar hojas estilizadas (reutilizable)"""
        styles = {
    ...
    def export_excel(self):
        ...
        # 5. SIG_DATOS_VARIABLES (Exclusivo SIG)
        ...
        # Borramos la default que se creó al inicio
...
if __name__ == "__main__":
    try:
        print("INICIANDO PROCESADOR MASIVO ADP v1.1.0 (5 Hojas Separadas)")
