...
# =============================================================================
# IPS_ADP_PARSER_v1.0.5 - FIX COLUMNA ARCHIVO/HOJA
# =============================================================================

class IPS_ADP_Parser:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.output_file = os.path.join(folder_path, "CONSOLIDADO_ADP_v1.0.5.xlsx")
        self.data_tree = {} 
        self.flat_data = [] 
        self.variable_data = [] 
    ...
    def configure(self):
        print("\n" + "="*60)
        print("   CONFIGURACIÓN MAESTRA ADP v1.0.5")
        print("="*60)
    ...
    def process_folder(self):
        ...
        for idx_file, file_path in enumerate(files):
            # EXTRAE EL NOMBRE DEL ARCHIVO ESTRICTAMENTE
            ...
            for sheet in sheet_names:
                ...
                while i < len(df):
                    ...
                    if str_num != "" and str_num.upper() not in ["NAN", "NONE"]:
                        ...
                        # ASIGNACIÓN ESTRICTA DEL NOMBRE DEL ARCHIVO Y HOJA
                        temp_data = {
...
if __name__ == "__main__":
    try:
        print("INICIANDO PROCESADOR MASIVO ADP v1.0.5")
