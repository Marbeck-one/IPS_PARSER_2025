...
# =============================================================================
# IPS_ADP_PARSER_v1.0.8 - FIX CABECERAS MAL ESCRITAS (Ej: Proyección Coquimbo)
# =============================================================================
...
class IPS_ADP_Parser:
    ...
    def configure(self):
        print("\n" + "="*60)
        print("   CONFIGURACIÓN MAESTRA ADP v1.0.8")
        print("="*60)
        ...
        for idx_file, file_path in enumerate(files):
            ...
            for sheet in sheet_names:
                ...
                for idx in range(min(15, len(df))):
                    ...
                    # Buscamos NÚMERO o la dupla INDICADOR+FORMULA (para Coquimbo)
                ...
                # FIX: Si la planilla no dice "NUMERO" en la primera columna (Ej: Coquimbo)
                if col_num is None:
                    col_num = 0
                    if col_ind == 0:
                        col_ind = 1
...
if __name__ == "__main__":
    try:
        print("INICIANDO PROCESADOR MASIVO ADP v1.0.8")
