...
# =============================================================================
# IPS_PARSER_v3.7.4 - FIX: LÍMITE DE BÚSQUEDA (NO LEER TABLA) + CORRECCIÓN NOMBRE
# =============================================================================

class IPSParserV374:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.output_file = os.path.join(folder_path, "IPS_CONSOLIDADO_V3.7.4.xlsx")
        self.data_tree = {} 
        self.flat_data = [] 
        self.variable_data = [] 
    ...
    def configure(self):
        print("\n" + "="*60)
        print("   CONFIGURACIÓN MAESTRA v3.7.4")
        print("="*60)
    ...
    def find_center_responsibility(self, df, limit_row):
        # FIX: Ahora recibe 'limit_row' que es el índice donde empieza la tabla (NÚMERO)
        # El buscador NO PUEDE pasar de esa fila.
        
        search_limit = min(limit_row, 20) # Busca hasta 'NÚMERO' o máx 20 filas
        ...
        for r in range(search_limit):
            for c in range(limit_col):
                ...
                # Ignorar encabezados de columna sueltos si aparecieran antes
    ...
    def process_folder(self):
        ...
        for idx_file, file_path in enumerate(files):
            ...
            last_found_center = None # Reiniciar memoria por archivo
            ...
            for sheet in sheet_names:
                ...
                # 2. ENCONTRAR DONDE EMPIEZA LA TABLA (PARA USARLO DE LÍMITE)
                h_idx = None
                ...
                if h_idx is None:
                    continue # Hoja vacía o sin tabla, saltar

                # 3. BÚSQUEDA DEL EQUIPO (CON LÍMITE)
                # Solo buscamos hasta la fila h_idx. ¡Nunca entramos a la tabla!
...
if __name__ == "__main__":
    try:
        ...
        if os.path.isdir(path):
            parser = IPSParserV374(path) # Ahora sí coincide
