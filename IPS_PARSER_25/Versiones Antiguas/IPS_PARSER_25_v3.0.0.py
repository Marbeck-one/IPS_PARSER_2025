...
# =============================================================================
# IPS_PARSER_v3.0.0 - ESTRATEGIA GLOBAL DE OCULTOS + MEMORIA
# =============================================================================
...
class IPSParserV300:
    def __init__(self, folder_path):
        ...
        self.opt_hidden_strategy = 'interactive' # 'visible', 'all', 'interactive'
    ...
    def configure(self):
        ...
        # 2. Estrategia de Filas Ocultas
        print("\n2. ¿Cómo manejar filas OCULTAS en Excel?")
    ...
    def ask_action(self, msg):
        print(f"\n[ATENCIÓN] {msg}")
        print("  [c] Procesar de todas maneras (Rellenar).")
    ...
    def ask_hidden_rows_action(self, count, sheet_name):
        # Solo se llama si la estrategia es 'interactive'
    ...
    def process_folder(self):
        ...
        for file_path in files:
            ...
            print(f"\n>>> PROCESANDO ({self.files_processed + 1}/{len(files)}): {file_name}")
            
            try:
                xls = pd.ExcelFile(file_path)
                sheet_names = xls.sheet_names
            except Exception as e:
                print(f"  [ERROR CRÍTICO] No se leyó archivo: {e}")
            ...
            for sheet in sheet_names:
                ...
                if h_idx is None:
                    continue # Silencioso para hojas basura
                ...
                if missing:
                    action = self.ask_action(f"Hoja '{sheet}' faltan: {missing}")
            ...
            self.files_processed += 1
            if skip_file_flag: print("  [SALTO] Archivo omitido por decisión del usuario.")
