...
# =============================================================================
# IPS_PARSER_v3.4.0 - COLUMNA 'EQUIPO' TRANSVERSAL
# =============================================================================

class IPSParserV340:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.output_file = os.path.join(folder_path, "IPS_CONSOLIDADO_V3.4.xlsx")
        self.data_tree = {} 
        self.flat_data = [] 
        self.variable_data = [] 
    ...
    def configure(self):
        print("\n" + "="*60)
        print("   CONFIGURACIÓN MAESTRA v3.4")
        print("="*60)
    ...
    def process_folder(self):
        ...
        for idx_file, file_path in enumerate(files):
            ...
            for sheet in sheet_names:
                ...
                # 2. DETECCIÓN DE "CENTRO DE RESPONSABILIDAD"
                ...
                if center_resp_name is None:
                    ...
                    for idx, row in df.iterrows():
                        ...
                        if any(x in row_vals for x in ["NÚMERO", "NUMERO", "N°"]):
                            h_idx_temp = idx
                            break
                    if h_idx_temp is not None:
                        center_resp_name = self.ask_center_resp_manual(sheet, file_name)
                        if center_resp_name is None: continue 

                # Definimos la variable para uso general
                ...
                for i in range(h_idx + 1, len(df)):
                    ...
                    # 1. CARGA BRUTA (Con nueva columna EQUIPO)
                    row_data = {
                        "ARCHIVO": file_name, 
                        "HOJA": sheet, 
                        "EQUIPO": centro_uso, # NUEVA COLUMNA INYECTADA
                        "NÚMERO": final_code,
    ...
    def export_excel(self):
        ...
        for fname, sheets in self.data_tree.items():
            ...
            for sname, rows in sheets.items():
                ...
                # Aquí se genera la cabecera. Como EQUIPO ya está en rows[0], aparecerá antes de NÚMERO
